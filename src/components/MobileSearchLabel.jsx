...
function SearchLabel({
  ...
  return (
    <label
      className="relative space-x-2 items-center flex"
      ref={inputRef}
    >
      <input
        type="text"
        ...
        } placeholder:text-white text-white outline-none placeholder:text-sm transition-all duration-300 py-1 px-1 rounded-md w-[270px]`}
      ...
      <button
        onClick={() => setIsMobileSearchClicked(false)}
        className={`bg-black text-white shadow-sm shadow-white ${
          isScrolled ? 'bg-slate-950 hover:bg-black' : 'hover:bg-slate-950'
        } px-1 py-1 rounded-md transition-all duration-300 hover:text-white`}
