...
function PersonGridTemplate({
  ...
  return (
    <div
      className={`grid sm:gap-10 gap-6 gap-y-10 grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 h-full ${
...
export default PersonGridTemplate;
